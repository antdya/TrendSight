...
1. $REPO/projects/$PRODUCT/memory/signal_log.md (если файл есть — возьми последние 4–8 недель; если пустой — пропусти)
...
После выполнения промта выведи пользователю подтверждение успешного результата и предложи выполнить следующий шаг - step-3.md.